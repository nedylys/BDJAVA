...
INSERT INTO Produit VALUES (8, 'Yaourt nature fermier', 'laitage', 'Yaourt artisanal au lait entier de ferme', 7);
INSERT INTO Produit VALUES (10, 'Jus d’orange frais', 'boisson', 'Jus pressé artisanal 100% orange', 6);
INSERT INTO Produit VALUES (11, 'Riz basmati premium', 'cereales', 'Riz basmati long grain parfumé', 12);
INSERT INTO Produit VALUES (12, 'Haricots rouges', 'legumineuse', 'Haricots rouges secs de qualité', 9);
INSERT INTO Produit VALUES (13, 'Amandes grillées', 'fruits secs', 'Amandes grillées sans sel', 8);
INSERT INTO Produit VALUES (14, 'Huile d’olive vierge', 'huile', 'Huile d’olive pressée à froid', 10);
INSERT INTO Produit VALUES (15, 'Steak haché bio', 'viande', 'Bœuf élevé en plein air', 11);
INSERT INTO Produit VALUES (16, 'Lait demi-écrémé', 'laitage', 'Lait frais demi-écrémé pasteurisé', 2);
INSERT INTO Produit VALUES (17, 'Tomates cerises', 'legume', 'Tomates cerises locales', 11);
INSERT INTO Produit VALUES (18, 'Pommes Golden', 'fruit', 'Pommes Golden croquantes', 5);
INSERT INTO Produit VALUES (20, 'Spaghetti artisanal', 'pates', 'Pâtes produites de manière traditionnelle', 3);
...
-- === 10. Lots de produits ===
INSERT INTO LotProduit VALUES ('vrac', 1, TO_DATE('2000-31-12','YYYY-MM-DD'), 0, 'DLUO', TO_DATE('2025-11-14','YYYY-MM-DD'), 10.00, 6.00, 1);
INSERT INTO LotProduit VALUES ('preconditionne', 0.5, TO_DATE('2000-31-12','YYYY-MM-DD'), 0, 'DLC', TO_DATE('2026-01-20','YYYY-MM-DD'), 25.00, 15.00, 2);
INSERT INTO LotProduit VALUES ('vrac', 1, TO_DATE('2000-12-31','YYYY-MM-DD'), 0, 'DLUO', TO_DATE('2026-09-15','YYYY-MM-DD'), 12.00, 7.00, 3);
INSERT INTO LotProduit VALUES ('vrac', 1, TO_DATE('2025-12-31','YYYY-MM-DD'), 0, 'DLUO', TO_DATE('2026-05-01','YYYY-MM-DD'), 4.50, 2.00, 4);
INSERT INTO LotProduit VALUES ('vrac', 1, TO_DATE('2000-12-31','YYYY-MM-DD'), 0, 'DLUO', TO_DATE('2026-02-01','YYYY-MM-DD'), 15.00, 8.00, 5);
...
-- === 20. Produit a pour saison(s) de disponibilité ===
...
-- === 21. Date de Récupération d'une commande ===
INSERT INTO DateRecuperation (DateRecuperation)
VALUES (TO_DATE('30-NOV-25', 'DD-MON-RR'));

-- === 21. Association Commande date de Récupération ===
