...
public class ClotureCommande {
    ...
    public void cloturerCommande() {
        ...
        try {
            ...
            if (choix == 1) {
                String requete1 ="SELECT DISTINCT c.idCommande, c.idClient, c.ModeRecuperation " +
                                ...
                                "       AND commandeenboutique.statutcommandeb != 'AnnulÃƒÂ©e' " +
                                "       AND commandealivrer.statutcommandel != 'Livree' " +
                                "       AND commandealivrer.statutcommandel != 'AnnulÃƒÂ©e')";
            ...
            while (rs.next()) {
                ...
                System.out.println("Mode rÃƒÂ©cupÃƒÂ©ration : " + rs.getString("ModeRecuperation"));
                System.out.println("------------------------------");
            }

            if (vide) {
                System.out.println("Aucune commande trouvÃƒÂ©e.");
            }
            ...
            System.out.println("\nEntrez l'ID de la commande Ãƒ  clÃƒÂ´turer :\n");
            ...
            if ( modeRecup.equals("Retrait") ) {
                ...
                System.out.print("Date estimÃƒÂ©e de livraison (YYYY-MM-DD) : ");
                ...
                System.out.println("Mode de rÃƒÂ©cupÃƒÂ©ration invalide.");
                retour();
                return ;
            }
            connection.commit();
            System.out.print(
            "\n=== La commande est en cours de clÃƒÂ´ture : \n "+
            "=== Tapez 0 pour retour \n " +
            "=== Valider l'achat : V = validÃƒÂ©e, A = AnnulÃƒÂ©e .\n");
            ...
            if (key.equals("V") && modeRecup.equals("Retrait")) {
                ...
                System.out.println("Commande marquÃƒÂ©e comme RÃƒÂ©cupÃƒÂ©rÃƒÂ©e !");
                ...
                System.out.println("Commande marquÃƒÂ©e comme LivrÃƒÂ©e !");
                connection.commit();
                ...
                ps1.setString(1, "AnnulÃƒÂ©e");
                ps1.setInt(2, id);
                ps1.executeUpdate();

                PreparedStatement ps2 = connection.prepareStatement(req2);
                ps2.setString(1, "AnnulÃƒÂ©e");
                ps2.setInt(2, id);
                ps2.executeUpdate();

                System.out.println("Commande annulÃƒÂ©e !");
                retour();
                return;
            }
                ...
                connection.rollback();
                System.out.println("Choix invalide. La commande n'a pas ÃƒÂ©tÃƒÂ© clÃƒÂ´turÃƒÂ©e.");
                retour();
                return; }
        ...
        System.out.println("Commande clÃƒÂ´turÃƒÂ©e avec succÃƒÂ¨s !");
